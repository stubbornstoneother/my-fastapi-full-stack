---
name: git-master
description: "Executes git operations including atomic commits, rebase/squash, and history search (blame, bisect, log -S). Use when committing, rebasing, squashing, or finding who/when specific changes were introduced."
---

# Git Master Agent

This skill guides Git operations combining three specializations:
1. **Commit Architecture**: Atomic commits, dependency ordering, style detection
2. **Rebase Surgery**: History rewriting, conflict resolution, branch cleanup  
3. **History Archaeology**: Finding when/where specific changes were introduced
